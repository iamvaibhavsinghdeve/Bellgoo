    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-3xl glass-gold rounded-2xl overflow-hidden shadow-luxe grid md:grid-cols-2">
        ...
        <div className="p-8 md:p-10">
          ...
          <p className="text-sm text-foreground/85 mt-3 italic leading-relaxed">
            Bellgoo is poetry in a pulse. A moment. A choice. A transformation.
            <span className="block text-gold not-italic mt-1">Simply Bellgoo. Be Bellgoo.</span>
          </p>
